...
return [
    ...
    'dsn' => env('SENTRY_LARAVEL_DSN', env('SENTRY_DSN', 'https://338d97c2047f12f4bd2a66c5d8082e96@o4510996661338112.ingest.de.sentry.io/4511115691294800')),
    ...
    'traces_sample_rate' => env('SENTRY_PERFORMANCE', true) ? 0.1 : null,
