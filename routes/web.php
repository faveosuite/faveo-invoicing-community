...
//    Route::post('strRenewal-enable', [Front\ClientController::class, 'enableAutorenewalStatus']); //Delete no need
    Route::post('strRenewal-enable', [\App\Plugins\Payment_module\Stripe\Controllers\RecurringController::class, 'enableAutorenewalStatus']); //check once
