...
@section('content')
    ...
    $feeAmount = intval(ceil(Cart::getSubTotal()*$processingFee));
    ...
    <form name='razorpayform' action="{!!url('payment/'.$invoice->id)!!}" method="POST">
        ...
        <input type="hidden" name="razorpay_all" id="razorpay_all">
        ...
        <script>
             ...
             */
                options.handler = function (response){
                    ...
                    document.getElementById('razorpay_all').value=response;
