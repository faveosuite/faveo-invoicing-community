...
class UpdateSettingsRequest extends FormRequest
{
    ...
    public function attributes()
    {
        return [
            ...
            'error_message' => __('recaptcha::recaptcha.error_message'),
    ...
    public function messages()
    {
        return [
            ...
            'error_message.required' => __('recaptcha::recaptcha.error_message_required'),
            'error_message.max' => __('recaptcha::recaptcha.error_message_max'),
