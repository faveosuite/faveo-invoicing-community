...
return [
    ...
    */
    ...
    'recaptcha_v2_invisible' => 'reCAPTCHA v2 不可見',
    'recaptcha_v2_checkbox' => 'reCAPTCHA v2 核取方塊',
    'select_captcha_type' => '選取要使用的 reCAPTCHA 版本',
    'failover_action' => '容錯移轉動作',
    'none' => '無',
    ...
    */
    ...
    'v3_secret_key' => 'v3 秘密金鑰',
    'enter_v3_secret_key' => '輸入您的 reCAPTCHA v3 秘密金鑰',
    ...
    */
    ...
    'v3_secret_key_required' => '需要 reCAPTCHA v3 秘密金鑰',
    'v2_site_key_required' => '需要 reCAPTCHA v2 網站金鑰',
    'v2_secret_key_required' => '需要 reCAPTCHA v2 秘密金鑰',
    'valid_recaptcha_site_key' => '請輸入有效的 reCAPTCHA 網站金鑰',
    'valid_recaptcha_secret_key' => '請輸入有效的 reCAPTCHA 秘密金鑰',
    'score_threshold_required' => 'reCAPTCHA v3 需要分數閾值',
    'valid_number' => '請輸入一個有效的數字',
    'complete_recaptcha_v3' => '無法產生 reCAPTCHA 權杖。請驗證網站金鑰是否設定正確且有效。',
    'failed_generate_v3_token' => '無法產生 reCAPTCHA 權杖。請驗證網站金鑰是否設定正確且有效。',
    ...
    */
    ...
    'failover_action_in' => '選取的容錯移轉動作無效',
    'score_threshold_numeric' => '分數閾值必須是數字',
    'score_threshold_min' => '分數閾值必須至少為 0',
    'score_threshold_max' => '分數閾值不得大於 1',
    'theme_required' => '需要主題',
    'theme_in' => '選取的主題無效',
    'size_required' => '需要大小',
    'size_in' => '選取的大小無效',
    'badge_position_required' => '需要徽章位置',
    'badge_position_in' => '選取的徽章位置無效',
];
