...
return [
    ...
    'users' => ['title' => 'message.users', 'description' => 'Manage user accounts and permissions.'],
    ...
    'products/plans/create' => ['title' => 'message.plans', 'description' => 'Create a new pricing plan.'],
    ...
    'products/groups' => ['title' => 'message.groups', 'description' => 'Manage product groups.'],
    ...
    'settings/cloud-details' => ['title' => 'message.cloud_details', 'description' => 'Configure cloud hosting details.'],
    ...
    'settings/seo' => ['title' => 'message.seo', 'description' => 'Configure SEO settings.'],
    'settings/seo/pages' => ['title' => 'message.seo', 'description' => 'Manage default SEO pages.'],
    ...
    'settings/api/github' => ['title' => 'message.github_heading', 'description' => 'Configure GitHub integration settings.'],
    ...
    'settings/api/zoho/*' => ['title' => 'message.zoho_settings', 'description' => 'Configure Zoho platform settings.'],

    'settings/common/tax' => ['title' => 'message.tax', 'description' => 'Manage tax rates.'],
    'settings/common/tax/create' => ['title' => 'message.tax', 'description' => 'Create a new tax rate.'],
    ...
    'settings/common/cache/*' => ['title' => 'message.cache', 'description' => 'Configure a cache driver.'],
    ...
    'versions/*/view' => ['title' => 'message.versions', 'description' => 'View version details.'],
    ...
    'licenses/create' => ['title' => 'message.licenses', 'description' => 'Create a new license.'],
    'licenses/*/edit' => ['title' => 'message.licenses', 'description' => 'Edit a license.'],
    'licenses/*/view' => ['title' => 'message.licenses', 'description' => 'View license details.'],
    ...
    'installations/*/edit' => ['title' => 'message.installations', 'description' => 'Edit an installation.'],
    'installations/*/view' => ['title' => 'message.installations', 'description' => 'View installation details.'],
    ...
    'server/update-notifications' => ['title' => 'message.server_notifications', 'description' => 'Customize update notifications.'],
