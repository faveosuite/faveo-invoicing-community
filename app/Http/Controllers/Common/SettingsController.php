...
//
//            // Step 1: Load Base Query
//            $query = $this->getBaseQueryForSystemLogs($from,$till);
//           // dd($query);
//
//            // Step 2: Search Filter
//            $query = $this->searchQuery($query, $searchString);
//
//            // Step 3: Date Filter
//            if ($from || $till) {
//                $query = $this->adSearch($from, $till, $query);
//            }
//
//            // Step 4: Sorting
...
//
//            // Step 5: Pagination
//            $logs = $query->simplePaginate($limit);
//          // dd($logs->getCollection());
//
//            // Step 6: Data Format Response
...
//            });
//
//            return successResponse('Activity logs fetched successfully', $logs);
//        } catch (\Exception $e) {
