...
class ClientController extends BaseClientController
{
    ...
    public function getOrder($id)
    {
        try {
            ...
            $renewAgents = $latestAgents ?: 'Unlimited';
            $renewPlanPrice = \App\Model\Payment\PlanPrice::where('plan_id', $planIdOld)
            ...
            return view(
                ...
                compact('invoice', 'order', 'user', 'product', 'subscription', 'licenseStatus', 'installationDetails', 'allowDomainStatus', 'date',
                    ...
                    'price', 'installation_path', 'latestAgents', 'terminatedOrderId', 'terminatedOrderNumber', 'payment_log', 'plans', 'planNameReal', 'whatsappStatus', 'app_id', 'config_id', 'autorenewal_status', 'actualWhatsappStatus', 'renewAgents', 'renewPlanPrice',
                )
            );
        } catch (Exception $ex) {
            return redirect()->back()->with('fails', $ex->getMessage());
