<template>
    ...
    <div class="card card-light">
            <div class="card-header callbacks">
                <h3 class="card-title ">{{lang('expiring_support')}}</h3>
...
export default {
    ...
    data(){
        ...
        return {
            ...
            columns:['license_code','product','license_date','license_support_date', 'license_status'],
    ...
    beforeMount(){
        ...
        this.options ={
            ...
            headings: {
                ...
                license_support_date: this.lang('support'),
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (data) {
                        ...
                        this.$emit('expiringSupport', 'expiringSupport', data)
                    }
                })
                .catch((error) => {
