...
class CallBackController extends Controller
{
    public function licneseCallbacks(Request $request)
    {
        ...
        $paginatedCallbacks = DB::table('license_callbacks')
            ->selectRaw('license_callbacks.id, license_callbacks.product_id, license_callbacks.user_id, license_callbacks.license_code, license_callbacks.callback_domain, license_callbacks.callback_ip, license_callbacks.callback_date_time, license_callbacks.callback_status, products.name as name, users.email as client_email')
    ...
    public function updateCallbacks(Request $request)
    {
       ...
       $updateCallbacks = DB::table('version_callbacks')
           ->selectRaw('version_callbacks.id, version_callbacks.version_id, version_callbacks.callback_ip, version_callbacks.callback_type, version_callbacks.callback_date_time, version_callbacks.callback_status, products.name as name, product_versions.version_number')
           ->leftJoin('products', 'version_callbacks.id', '=', 'products.id')
