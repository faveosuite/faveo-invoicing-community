...
class ClientsViewController extends Controller
{
    ...
    public function getClientInstallations(Request $request,$client_id)
    {
        ...
        $clientInstallations = DB::table('installations')
            ->selectRaw('installations.id, installations.user_id as client_id, installations.installation_domain, installations.installation_ip, installations.installation_date, installations.installation_status, products.name as name')
    ...
    public function getClientLicenses(Request $request,$client_id)
    {
        ...
        $productLicenses = DB::table('licenses')
            ->selectRaw('licenses.id as license_id, licenses.id, licenses.user_id as client_id, licenses.license_code, licenses.license_order_number, licenses.license_date, licenses.license_expire_date, licenses.license_updates_date, licenses.license_support_date, licenses.license_status, products.name as name')
