...
return [
    ...
    */
    ...
    'order_delete' => 'Are you sure? Deleting this order permanently will also delete the associated cloud order. This action cannot be undone.',
    ...
    'user_delete' => 'Are you sure? Deleting this user permanently will also delete all associated invoices, orders, subscriptions, cloud orders, and comments. This action cannot be undone.',
