...
return [
    ...
    */
    ...
    'apply_build_hint' => 'Upload the build once, then apply it to as many products as you like — each one gets its own release pointing at that same file, so nothing is uploaded twice. The moment a product is actually downloaded, its own product key and license are added in automatically, so every product\'s download stays completely separate from every other product\'s.',
    ...
    'coupon-code-exists' => 'This coupon code already exists.',
    ...
    'add-new' => 'Add New',
    'all-users' => 'All Users',
    'suspended_users' => 'Suspended Contacts',
    ...
    'delete_activity' => 'Activity Log Deletion',
    ...
    'tt_priority' => 'Choose a priority for this tax rate. Only one matching rate per priority is used. To charge more than one tax on the same order, give each rate a different priority.',
    ...
    'invoice-not-paid' => 'This invoice has not been paid yet and cannot be executed.',
    ...
    'invoice_detail_page' => 'Invoice Details',
    'invoice' => 'Invoice',
    'invoices' => 'Invoices',
    ...
    'tt_default_page' => 'The page a client is redirected to after login.',
    'page_settings' => 'Page Settings',
    'demo_request_button' => 'Demo Request Button',
    'tt_demo_request_button' => 'Shows a "Book a Demo" button on the storefront for visitors to request a demo.',
    ...
    'allow_newsletter' => 'Allow Newsletter Subscription',
    'newsletter_not_configured' => 'Newsletter integration is not configured. Enable it in the API settings.',
    /*
     * Service Provider
     */
    'pricing' => 'Pricing',
    ...
    'amount_exceeds_invoice_due' => 'The amount applied exceeds what is still due on the invoice.',
    'insufficient_unapplied_payment' => 'The amount applied exceeds the unused amount available.',
    'unapplied_payment' => 'Money the client has paid that no invoice has claimed yet',
    'unapplied_balance' => 'Unused Amount',
    'apply_payment_to_invoices' => 'Apply Payment to Invoices',
    'amount_applied' => 'Amount Applied',
    'payment_currency_mismatch' => 'All selected invoices must be in the same currency as the payment.',
    'credit_history_added' => 'Credit of :amount was added to your balance.',
    'credit_history_applied' => 'Credit of :amount was applied to invoice :number.',
    'credit_type' => 'Type',
    'credit_note' => 'Note',
    'credit_type_overpayment' => 'Overpayment',
    'credit_type_manual_grant' => 'Manual Credit',
    'credit_type_downgrade_proration' => 'Plan Downgrade Credit',
    'credit_type_applied_to_invoice' => 'Applied to Invoice',
    'credit_applied' => 'Credit Applied',
    'credit_to_apply' => 'Credit to Apply',
    'use_credit_balance' => 'Use my available balance (:amount available)',
    ...
    'all_system_logs' => 'All System Logs',
    ...
    'agents_unlimited_hint' => 'Enter 0 for unlimited agents.',
    'agents_number' => 'Agents must be a whole number between 0 and 9999.',
    ...
    'order_delete' => 'Are you sure? Deleting this order permanently will also remove any associated installation. This action cannot be undone.',
    'order_delete_selected' => 'Are you sure? Deleting :count selected order(s) will also remove any associated installations. This action cannot be undone.',
    ...
    'all_msg_reports' => 'All MSG91 Reports',
    ...
    'zoho_platform_settings' => 'Zoho Settings',
    'zoho' => 'Zoho',
    ...
    'zoho_mapping_owner_blocked' => ':field: This field is managed by Zoho and requires a Zoho user. You don\'t need to map a local field to it; Zoho will assign it automatically.',
    'zoho_mapping_lookup_blocked' => ':field: This field must be linked to an existing record in Zoho. A local field cannot be used here because it may create a duplicate record instead of linking to the existing one.',
    'zoho_mapping_image_blocked' => ':field: This field requires an uploaded image in Zoho. A local field cannot provide that, so it cannot be mapped here.',
    'zoho_mapping_datetime_blocked' => ':field: This field is managed by Zoho and updates automatically. Mapping a local field to it will have no effect.',
    'zoho_mapping_picklist_has_options' => ':field: Zoho provides a predefined list of options for this field. Please select one of the available Zoho options instead of mapping a local field.',
    'zoho_mapping_type_mismatch' => ':field: This field expects :zoho_type in Zoho, but \':local_field\' only holds :local_type. Please choose a local field of the correct type, otherwise Zoho will reject the entire record when this mapping is used.',
    'zoho_field_type_text' => 'plain text',
    'zoho_field_type_email' => 'an email address',
    'zoho_field_type_phone' => 'a phone number',
    'zoho_field_type_number' => 'a number',
    'zoho_field_type_checkbox' => 'a yes/no value',
    'zoho_field_type_date' => 'a date',
    'zoho_field_type_datetime' => 'a date and time',
    'check' => 'Check',
    ...
    'page_not_found_desc' => 'We\'re sorry, but the page you were looking for doesn\'t exist.',
    ...
    'credit_balance_description' => 'Credit granted to this client, available to spend on a future invoice.',
    'invoice_no' => 'Invoice No',
    'invoice_total_description' => 'Total amount invoiced to this client, across every invoice.',
    'order_no' => 'Order No',
    'invoice_order_already_executed' => 'This invoice already has an order.',
    'invoice_execute_purchase_only' => 'Only a purchase invoice can be executed. Renewals, upgrades and agent changes are fulfilled when the payment is confirmed.',
    'invoice_type_purchase' => 'Purchase',
    'invoice_type_renewal' => 'Renewal',
    'invoice_type_upgrade_downgrade' => 'Upgrade',
    'invoice_type_agent_alteration' => 'Agent change',
    'paid' => 'Paid',
    'paid_description' => 'Total amount this client has actually paid.',
    'balance_description' => 'What this client still owes right now (Invoice Total minus Paid).',
    ...
    'network_error_retry' => 'Unable to reach the server. Please check your connection and try again.',
    'logout' => 'Logout',
    ...
    'auto_renewal_description' => 'Renew this license automatically before it expires.',
    ...
    'order_terminated_notice_title' => 'This order has been terminated',
    'order_terminated_notice_body' => 'Its features and license are no longer available.',
    'order_terminated_replacement' => 'Your active service is now under order',
    'order_created_from_predecessor' => 'This order replaces order',
    ...
    'machine_id_tooltip' => 'Enter the machine ID reported by your installation to bind your offline license file to this specific server. This is only needed once.',
    'enter_machine_id' => 'Enter your machine ID',
    ...
    'change_no_of_agents' => 'Manage Agents',
    'price_per_agent' => 'Price per agent:',
    'choose_no_desired_agents' => 'How many agents do you want?',
    'update_agents' => 'Update Agents',
    'add_one_agent' => 'Add 1 agent',
    'add_agents_count' => 'Add :count agents',
    'remove_one_agent' => 'Remove 1 agent',
    'remove_agents_count' => 'Remove :count agents',
    'new_agent_count_cost' => ':count agents for the rest of this cycle',
    'unused_current_agents_credit' => 'Credit for unused time on :count agents',
    'price_due_today' => 'You pay today',
    'agent_proration_note' => "This covers you until your next bill. After that, you'll pay the full price for :count agents.",
    'increase' => 'Increase',
    'decrease' => 'Decrease',
    ...
    'total_credits_remaining' => 'Credit for unused time on your current plan',
    'price_for_new_plan' => 'New plan for the rest of this cycle',
    'credit_deducted_label' => 'Deducted from your credit',
    'price_to_be_paid' => 'Price to be paid:',
    'future_plan_credit_label' => 'Added to your account as credit for later',
    ...
    'debugging_settings' => 'Debugging Options',
    ...
    'aws_key_id_required' => 'AWS Key ID is required.',
    'aws_secret_required' => 'AWS Secret is required.',
    'aws_region_required' => 'AWS Region is required.',
    'dynamodb_table_required' => 'DynamoDB cache table is required.',
    'port_must_be_number' => 'Port must be a valid number.',
    'api' => 'Api',
    ...
    'move' => 'Move',
    'atleast_one_column_needs_to_be_selected' => 'At least one column needs to be selected',
    'search' => 'Search',
    ...
    'fields_not_permitted' => 'This license type doesn\'t allow setting: :fields. Nothing was changed.',
    'some_fields_not_permitted' => 'Updated — but this license type doesn\'t allow setting: :fields, so those were left unchanged.',
    'some_dates_not_editable' => 'Some dates aren\'t editable for this license type.',
    'switch_localized_license' => 'Switch to localized license?',
    'localized_license_tooltip' => 'When enabled, the license is stored as an encrypted file on the client\'s server instead of being validated online. The client must download and place the license files in the correct directory for Faveo to function.',
    ...
    'cache_driver_settings' => 'Cache Driver Settings',
    'caps_others' => 'OTHERS',
    'others' => 'Others',
    ...
    // user-client panel
    'create_new_user' => 'Create Contact',
    'create_user' => 'Create Contact',
    'position' => 'Position',
    'company_type' => 'Company Type',
    'company_size' => 'Company Size',
    'choose_a_country' => 'Choose a country',
    'enter_valid_number' => 'Please enter a valid number',
    'edit_user' => 'Edit Contact',
    ...
    'suspend_selected_users_confirm' => 'Suspend :count selected user(s)? They can be restored later from Suspended Contacts.',
    'suspend_user_confirm' => 'Are you sure you want to suspend this user? They can be restored later from Suspended Contacts.',
    ...
    'two_factor_authentication_description' => 'Add an extra layer of security using an authenticator app.',
    ...
    'open_payment' => [
        ...
        'amount_max' => 'Amount cannot exceed 50,000,000.',
    ],
    'caps_items' => 'ITEMS',
    'retry' => 'Retry',
    ...
    'cannot_delete_invoice_with_order' => 'This invoice cannot be deleted because an order is associated with it.',
    'delete_invoice' => 'Delete Invoice',
    'delete_invoice_confirm' => 'Are you sure you want to delete invoice :number? This action cannot be undone.',
    ...
    'timezone_required' => 'Timezone field is required.',
    'date_format_required' => 'Date format field is required.',
    'time_format_required' => 'Time format field is required.',
    ...
    'social_login_client_id_required' => 'Client ID is required.',
    'social_login_client_secret_required' => 'Client Secret is required.',
    'social_login_redirect_url_required' => 'Redirect URL is required.',
    ...
    'subscription_expired' => 'Subscription Expired Reminder',
    ...
    'post_expiry_notification_tooltip' => 'Sends a reminder email after a subscription has already expired, prompting the customer to renew. Sent regardless of payment method, once the subscription is past its post-expiry grace period.',
    ...
    'msg91_reports_deletion' => 'MSG91 Reports Deletion',
    ...
    'processing_fee_invalid' => 'Processing fee must be a number between 0 and 100.',
    ...
    'stripe_secret_invalid' => 'The Stripe Secret Key should start with "sk_" or "rk_".',
    'stripe_key_invalid' => 'The Stripe Publishable Key should start with "pk_".',
    'razorpay_key_invalid' => 'The Razorpay Key should start with "rzp_".',
    'expired' => 'Expired',
    ...
    'large_email_batch_warning' => 'This manager has :count users. Saving will send :count notification emails.',
    'smtp_driver_warning' => 'Sending this many emails over SMTP may be slow or hit rate limits. Consider switching to a bulk mail driver (Mailgun, Amazon SES, Sparkpost).',
    'cloud_ci_config' => 'CI / CD Configuration',
    'cloud_job_url_hint' => 'Jenkins job URL for provisioning a cloud instance with a custom domain.',
    'cloud_job_url_normal_hint' => 'Jenkins job URL for provisioning a cloud instance with a standard subdomain.',
    'cloud_delete_job_url_normal_hint' => 'Jenkins job URL for deleting a standard subdomain cloud instance.',
    'cloud_delete_job_url_custom_hint' => 'Jenkins job URL for deleting a custom domain cloud instance.',
    'cloud_user_hint' => 'Jenkins username used to authenticate CI job requests.',
    'google_chat_webhook_hint' => 'Google Chat incoming webhook URL for cloud provisioning notifications. Stored encrypted.',
    'cloud_auth_hint' => 'Jenkins API token for authenticating CI job requests. Stored encrypted — leave blank to keep existing.',
    'cloud_oauth_token_hint' => 'OAuth token passed as a query parameter to Jenkins jobs. Stored encrypted — leave blank to keep existing.',
    'cloud_job_url' => 'Cloud Job URL',
    'cloud_job_url_normal' => 'Cloud Job URL (Normal)',
    'cloud_delete_job_url_normal' => 'Delete Job URL (Normal)',
    'cloud_delete_job_url_custom' => 'Delete Job URL (Custom Domain)',
    ...
    'cloud_token_write_only_hint' => 'Tokens are stored encrypted. Leave blank to keep the existing value.',
    'configured' => 'Configured',
    'enter_new_value_to_update' => 'Enter new value to update',
    'smtp_info_title' => 'SMTP is suitable for low-volume transactional email only.',
    'smtp_info_transactional' => 'Best for password resets, welcome emails, and individual notifications.',
    'smtp_info_bulk_limit' => 'Bulk operations (e.g. reassigning 200+ users to a new manager) will be blocked when using SMTP.',
    'smtp_info_bulk_recommend' => 'For bulk sending, switch to Mailgun, Amazon SES, or SparkPost.',
    'switch_mail_driver' => 'Update mail driver →',
    'smtp_confirm_proceed' => 'You are about to send a large batch of emails over SMTP. Are you sure you want to proceed?',
    ...
    'otp_sent_old_email' => 'We sent a verification code to your current email. Enter it to confirm this change.',
    'confirm_with_email' => 'Enter the verification code sent to your registered email to confirm this change.',
    'whatsapp_signup' => 'WhatsApp SignUp',
    'enter_valid_url' => 'Please enter a valid URL (https://example.com).',
    'whatsapp_deregister_meta_failed' => 'Removed from this application, but it is still connected in Meta.',
    ...
    'all_banned_hosts' => 'All Banned Hosts',
    'new_banned_host' => 'New Banned Host',
    'edit_banned_host' => 'Edit Banned Host',
    'banned_hosts' => 'Banned Hosts',
    'security_settings' => 'Banned Host Settings',
    'server_notifications' => 'Server Notifications',
    'license_notification' => 'License Notification',
    'update_notification' => 'Update Notification',
    'license_custom_notification' => 'License Custom Notification',
    'update_custom_notification' => 'Update Custom Notification',
    'log_reports' => 'Log Reports',
    'license_reports' => 'License Reports',
    ...
    'search_by_failure_reason' => 'Search by failure reason',
    'search_by_domain' => 'e.g. example.com',
    'new_date' => 'New Date',
    ...
    'debug_mode_description' => 'Enable application debug mode to display detailed error messages and stack traces.',
    ...
    'daily_at' => 'Daily At',
    'weekly' => 'Weekly',
    'cloud_mail_days' => 'Cloud Deletion (Days After Expiry)',
    'cloud_mail_days_tooltip' => "Deletes the customer's cloud instance this many days after their subscription expires.",
    'invoice_deletion_days' => 'Unpaid Invoice Retention (Days)',
    'invoice_deletion_days_tooltip' => "Deletes unpaid invoices that aren't linked to any order once they're older than this many days.",
    'msg91_report_days' => 'MSG91 Report Retention (Days)',
    'msg91_report_days_tooltip' => 'Deletes MSG91 SMS delivery reports older than this many days.',
    'reoon_log_days' => 'Reoon Log Retention (Days)',
    'reoon_log_days_tooltip' => 'Deletes Reoon email verification logs older than this many days.',
    'system_log_days' => 'System Log Retention (Days)',
    'system_log_days_tooltip' => 'Deletes application system logs older than this many days.',
    'installation_log_days' => 'Installation Inactivity (Days)',
    'installation_log_days_tooltip' => "Marks an installation as inactive once it hasn't checked in for this many days. Does not delete the installation.",
    'license_reports_days' => 'License Report Retention (Days)',
    'license_reports_days_tooltip' => 'Deletes license usage reports older than this many days.',
    'license_callbacks_days' => 'License Callback Retention (Days)',
    'license_callbacks_days_tooltip' => 'Deletes license callback records older than this many days.',
    'license_crack_days' => 'Crack Report Retention (Days)',
    'license_crack_days_tooltip' => 'Deletes license-crack detection reports older than this many days.',
    'license_system_days' => 'License System Report Retention (Days)',
    'license_system_days_tooltip' => 'Deletes license system reports older than this many days.',
    'license_versions_days' => 'Unpublished Version Retention (Days)',
    'license_versions_days_tooltip' => 'Deletes unpublished product version uploads older than this many days.',
    'activity_log_days' => 'Activity Log Retention (Days)',
    'activity_log_days_tooltip' => 'Deletes activity logs older than this many days.',
    'delete_all_reports' => 'Delete All Reports',
    'delete_all_logs' => 'Delete All Logs',
    'cron_days' => 'Cron Days',
    'expiry_mail_days' => 'Manual Renewal Reminder (Days Before Expiry)',
    'expiry_mail_days_tooltip' => 'Sends the manual-payment renewal reminder this many days before the subscription expires. Select multiple values to send at each threshold (e.g. 30, 15, 7, 1).',
    'auto_renewal_days' => 'Auto Renewal Reminder (Days Before Expiry)',
    'auto_renewal_days_tooltip' => 'Sends the auto-renewal reminder this many days before the subscription expires. Select multiple values to send at each threshold.',
    'post_expiry_days' => 'Expired Reminder (Days After Expiry)',
    'post_expiry_days_tooltip' => 'Sends the expired-subscription reminder this many days after the subscription has expired.',
    ...
    'delete_selected_users_confirm' => 'Delete :count selected user(s)? This action cannot be undone.',
    ...
    'reoon_logs_deletion' => 'Reoon Email Verification Logs Deletion',
    'installation_logs_cleanup' => 'Installation Logs Deactivation',
    ...
    'op_payments_disabled_title' => 'Payments are currently unavailable',
    'op_payments_disabled_body' => 'This payment page has been temporarily disabled. Please check back later.',
    ...
    'application_debugging_desc' => 'Debug and monitor application performance',
    ...
    'pulse_monitoring_desc' => 'Enable Laravel Pulse to monitor application health, performance and usage metrics.',
    'clockwork_debugging' => 'Clockwork debugging',
    'clockwork_debugging_desc' => 'Enable Clockwork profiler to inspect requests, queries and application runtime data.',
    'application_monitoring' => 'Application Monitoring',
    'application_monitoring_desc' => 'Error tracking and performance monitoring',
    'monitoring_options' => 'Monitoring Options',
    'sentry_crash_reporting' => 'Send app crash reports',
    'sentry_crash_reporting_tooltip' => 'Enable this to send crash reports for analysis',
    'sentry_crash_reporting_desc' => 'Send application crash reports to Sentry for error tracking and analysis.',
    'sentry_performance' => 'Send performance reports',
    'sentry_performance_tooltip' => 'Enable this to send performance data for analysis',
    'sentry_performance_desc' => 'Send performance data to Sentry for monitoring response times and bottlenecks.',
    'debugging_settings_saved_message' => 'Your error and debugging settings have been saved successfully',
    ...
    'invalid_domain' => 'Please enter a valid domain name or IP address.',
    ...
    'open_payment_status_updated' => 'Open Payments status updated successfully.',
    'open_payment_disabled' => 'Open payments are currently disabled.',
    ...
    'change_language_current' => 'Change language, current: :locale',
    'languages' => 'Languages',
    'user_menu_for' => 'User menu for :name',
    'avatar' => 'Avatar',
    'user_menu' => 'User menu',
    'breadcrumb' => 'Breadcrumb',
    'image_upload_failed' => 'Image upload failed',
    'tooltip_description' => 'Tooltip description',
    'enter_tooltip_text' => 'Enter the tooltip text...',
    'add_edit_tooltip_hint' => 'Add or edit a tooltip on selected text',
    'edit_tooltip' => 'Edit Tooltip',
    'select_text_for_tooltip' => 'Select the text you want to add a tooltip to first.',
    ...
    'only_png_jpeg_allowed' => 'Only PNG and JPEG images are allowed.',
    'image_max_2mb' => 'Image must be under 2 MB.',
    'hide_password' => 'Hide password',
    'show_password' => 'Show password',
    'domain_alphanumeric_hyphen_only' => 'Only letters, numbers, and hyphens are allowed.',
    'user_image' => 'User Image',
    'not_set' => 'Not set',
    'auto_renewal_subscription_hint' => 'Automatically renew when subscription ends',
    'cash' => 'Cash',
    'online_payment' => 'Online Payment',
    'basic_information_content' => 'Basic Information & Content',
    'product_image_source' => 'Product Image & Source',
    ...
    'email_verified_tooltip' => 'User\'s email address is verified',
    'email_not_verified_tooltip' => 'User\'s email address is not verified',
    'mobile_verified_tooltip' => 'User has verified mobile',
    'mobile_not_verified_tooltip' => 'User has not verified mobile',
    '2fa_enabled_tooltip' => 'User has enabled 2FA',
    '2fa_not_enabled_tooltip' => 'User has not enabled 2FA',
    'op_calculating' => 'Calculating…',
    'op_loading_secure_form' => 'Loading secure form…',
    'op_total_updated_fee_change' => 'The total has been updated to :amount due to a fee rate change.',
    'op_recaptcha_required' => 'Please complete the reCAPTCHA and try again.',
    'op_fix_highlighted_fields' => 'Please fix the highlighted fields and try again.',
    'op_too_many_attempts' => 'Too many attempts. Please wait a moment and try again.',
    'op_create_order_failed' => 'Failed to create order',
    'op_init_payment_failed' => 'Failed to initialize payment',
    'op_payment_not_completed' => 'Payment was not completed. Please try again.',
    'op_payment_failed_generic' => 'Payment failed',
    'op_payment_verification_failed' => 'Payment verification failed',
    'op_verification_failed' => 'Verification failed',
    'op_payment_still_processing' => 'Payment is still processing. Please check back later.',
    'deploy_on_existing_server' => 'Deploy on Existing Server',
    'deploy_on_fresh_server' => 'Deploy on Fresh Server',
    'deploy_ssh_connectivity' => 'SSH Connectivity',
    'deploy_deployment_path' => 'Deployment Path',
    'deploy_version_heading' => 'Version to Deploy',
    'deploy_live_deployment' => 'Live Deployment',
    'deploy_setup_complete' => 'Setup Complete!',
    'deploy_existing_server_desc' => 'Copies Faveo files to a configured server via SSH/SFTP. Fastest path for servers already running a web stack.',
    'deploy_fresh_server_desc' => 'Runs the Faveo install script on a bare OS — installs PHP, Apache/Nginx, MariaDB, Redis, and Supervisor.',
    'deploy_time_estimate' => '15–30 min',
    'deploy_credentials_notice' => 'Your credentials are never stored — used only for this request.',
    'deploy_success_desc' => 'Your Faveo instance has been successfully deployed.',
    'deploy_web_installer_desc' => 'Open this URL to complete the Faveo setup wizard.',
    'deploy_save_securely' => 'Save these securely.',
    'deploy_host_address' => 'Host Address',
    'deploy_auth_method' => 'Auth Method',
    'deploy_private_key_option' => 'Private Key',
    'deploy_ssh_password' => 'SSH Password',
    'deploy_ssh_private_key' => 'SSH Private Key',
    'deploy_sudo_password' => 'Sudo Password',
    'deploy_path_label' => 'Deploy Path',
    'deploy_domain' => 'Domain',
    'deploy_admin_email' => 'Admin Email',
    'deploy_web_server' => 'Web Server',
    'deploy_ssl_certificate' => 'SSL Certificate',
    'deploy_certificate_path' => 'Certificate Path',
    'deploy_key_path' => 'Key Path',
    'deploy_web_user' => 'Web User',
    'deploy_web_user_placeholder' => 'www-data (auto-detected if blank)',
    'deploy_web_installer' => 'Web Installer',
    'deploy_visit_web_installer' => 'Visit Web Installer',
    'deploy_detected_site_url' => 'Detected Site URL',
    'deploy_admin_credentials' => 'Administrator Credentials',
    'deploy_start_over' => 'Start Over',
    'deploy_ssl_lets_encrypt' => 'Let\'s Encrypt (free)',
    'deploy_ssl_self_signed' => 'Self-Signed',
    'deploy_ssl_paid_certificate' => 'Paid Certificate',
    'deploy_log_verifying_ssh' => 'Verifying SSH connection…',
    'deploy_log_running_install' => 'Running installation script (this may take 15–30 min)…',
    'deploy_log_uploading_files' => 'Uploading product files via SFTP…',
    'deploy_log_extracting_files' => 'Extracting files on remote server…',
    'deploy_failed_generic' => 'Deployment failed.',
    'open_payment_name_required' => 'Please enter your name.',
    'open_payment_name_max' => 'Name cannot exceed 100 characters.',
    'open_payment_email_required' => 'Please enter your email address.',
    'open_payment_email_invalid' => 'Please enter a valid email address.',
    'open_payment_mobile_required' => 'Please enter your mobile number.',
    'open_payment_mobile_min' => 'Mobile number must be at least 8 characters.',
    'open_payment_mobile_max' => 'Mobile number cannot exceed 20 characters.',
    'open_payment_address_required' => 'Please enter your address.',
    'open_payment_city_required' => 'Please enter your city.',
    'open_payment_state_required' => 'Please enter your state.',
    'open_payment_zip_required' => 'Please enter your ZIP/postal code.',
    'open_payment_zip_max' => 'ZIP code cannot exceed 15 characters.',
    'open_payment_country_required' => 'Please select your country.',
    'open_payment_company_required' => 'Please enter your company name.',
    'open_payment_amount_required' => 'Please enter the payment amount.',
    'open_payment_amount_numeric' => 'Amount must be a valid number.',
    'open_payment_amount_min' => 'Amount must be at least 1.',
    'open_payment_amount_max' => 'Amount cannot exceed 50,000,000.',
    'open_payment_currency_required' => 'Please select a currency.',
    'open_payment_currency_invalid' => 'Please select a supported currency.',
    'open_payment_gateway_required' => 'Please select a payment gateway.',
    'open_payment_gateway_invalid' => 'Gateway must be either Razorpay or Stripe.',
    'invalid_credentials' => 'Invalid Credentials',
    'plan_already_exists' => 'Plan already exists',
    'queue_driver_not_configured' => 'Queue driver not configured.',
    'product_relation_not_found' => 'Product relation not found.',
    'unauthenticated' => 'Unauthenticated.',
    'open_payment_order_create_failed' => 'Failed to create order: ',
    'order_created_successfully' => 'Order created successfully',
    'order_not_found' => 'Order not found',
    'open_payment_order_details_failed' => 'Failed to get order details: ',
    'order_already_paid' => 'This order has already been paid',
    'payment_prepare_failed' => 'Failed to prepare payment: ',
    'card_session_failed' => 'Failed to create card session: ',
    'payment_verification_failed' => 'Payment verification failed.',
    'invalid_signature' => 'Invalid signature.',
    'payment_not_completed' => 'Payment not completed.',
    'fetch_orders_failed' => 'Failed to fetch orders: ',
    'invalid_group_id' => 'Invalid group ID provided.',
    'invalid_monitoring_type' => 'Invalid monitoring type',
    'setting_not_found' => 'Setting not found.',
    'cart_product_no_active_plan' => 'This product has no active plan and cannot be added to the cart.',
    'configuration' => 'Configuration',
    'client_deployments' => 'Client Deployments',
    'eg' => '(e.g ',
    'type_class_name_placeholder' => 'Type a class name and press Enter',
    'standard' => 'Standard',
    'city_placeholder' => 'comma-separated',
    ...
    'open_payment_settings' => 'Open Payment Settings',
    'open_payment_page' => 'Open Payment Page',
    'open_payment_page_url' => 'Page URL',
    'from_date' => 'From Date',
    'to_date' => 'To Date',
    'detail' => 'Detail',
    'first_otp_sent' => 'First OTP sent',
    'no_description_available' => 'No description available.',
    'gateway_desc_paypal' => 'Accept payments worldwide using PayPal — one of the most trusted online payment platforms supporting 200+ countries and multiple currencies.',
    'gateway_desc_stripe' => 'Process cards, wallets, and local payment methods globally with Stripe\'s powerful developer-friendly payment infrastructure.',
    'gateway_desc_razorpay' => 'India\'s leading payment gateway supporting UPI, cards, net banking, wallets, and EMI with seamless checkout experience.',
    'gateway_desc_amazon' => 'Let customers pay using their Amazon account credentials for a fast, trusted, and familiar checkout experience.',
    'gateway_desc_google' => 'Enable fast and secure checkout with Google Pay — works across Android, Chrome, and the web.',
    'gateway_desc_apple' => 'Allow Apple device users to pay quickly and securely using Face ID, Touch ID, or passcode via Apple Pay.',
    'gateway_desc_mollie' => 'A flexible European payment gateway offering cards, iDEAL, Bancontact, SEPA, and many more local methods.',
    'gateway_desc_paytm' => 'India\'s popular digital wallet and payment gateway supporting UPI, cards, net banking, and Paytm wallet.',
    'gateway_desc_cashfree' => 'Fast and reliable payment gateway for Indian businesses with support for payouts, subscriptions, and instant settlements.',
    'gateway_desc_instamojo' => 'Simple payment gateway for Indian SMBs — accept payments via links, UPI, cards, and wallets with zero setup fees.',
    'gateway_desc_flutterwave' => 'Pan-African payment platform enabling businesses to accept and send payments across Africa and beyond.',
    'gateway_desc_paystack' => 'Africa\'s leading payment gateway with support for cards, bank transfers, USSD, and mobile money.',
    'gateway_desc_square' => 'Unified commerce solution with in-person and online payments, inventory management, and business analytics.',
    'gateway_desc_braintree' => 'A PayPal service offering flexible payment integrations with support for cards, PayPal, Venmo, and local methods.',
    'gateway_desc_authorize' => 'One of the most established payment gateways in the US, providing secure card processing and fraud detection.',
    'gateway_desc_ccavenue' => 'India\'s largest payment gateway with 200+ payment options including cards, net banking, UPI, and wallets.',
    'gateway_desc_payu' => 'Global payment platform present in 50+ markets, supporting local and international payment methods.',
    'gateway_desc_worldpay' => 'A global leader in payment processing — accept cards and alternative payment methods across 146 countries.',
    'gateway_desc_klarna' => 'Offer buy-now-pay-later, installment plans, and flexible financing options to boost conversions at checkout.',
    'gateway_desc_afterpay' => 'Let customers split purchases into 4 interest-free installments, increasing average order value and conversion.',
    'webhook_secret' => 'Webhook Secret',
    'webhook_purpose_subscription_charged' => 'Required for auto-renewal to actually work — without it, renewed subscriptions won\'t be extended even after Razorpay charges the customer.',
    'webhook_purpose_subscription_pending' => 'Required to record a renewal charge failing its first attempt — without it, a struggling auto-renewal is invisible until Razorpay exhausts all its retries.',
    'webhook_purpose_subscription_halted' => 'Required to detect failed renewals — without it, the app won\'t know a recurring charge stopped working, and auto-renewal stays silently broken.',
    'webhook_purpose_payment_captured' => 'Required to confirm invoice/order payments — without it, a customer can pay successfully and the invoice still won\'t be marked as paid.',
    'webhook_purpose_payment_failed' => 'Required to detect failed payments — without it, a failed payment attempt goes unnoticed and the customer is never told to retry.',
    'webhook_purpose_invoice_payment_succeeded' => 'Required for auto-renewal to actually work — without it, renewed subscriptions won\'t be extended even after Stripe charges the customer.',
    'webhook_purpose_invoice_payment_failed' => 'Required to detect failed renewals — without it, the app won\'t know a recurring charge stopped working, and auto-renewal stays silently broken.',
    'webhook_purpose_customer_subscription_deleted' => 'Required to keep auto-renewal status accurate — without it, a subscription cancelled in Stripe still shows as active here.',
    'webhook_purpose_checkout_session_completed' => 'Required to confirm invoice/order payments made via embedded Checkout — without it, a customer can pay successfully and the invoice still won\'t be marked as paid.',
    'webhook_purpose_payment_intent_succeeded' => 'Required to confirm invoice/order payments made by card — without it, a customer can pay successfully and the invoice still won\'t be marked as paid.',
    'webhook_purpose_payment_intent_payment_failed' => 'Required to detect failed payments — without it, a failed payment attempt goes unnoticed and the customer is never told to retry.',
    'accounts' => 'Accounts',
    'enter_api_key_placeholder' => 'Enter your API key',
    'enter_api_secret_placeholder' => 'Enter your API secret',
    'enter_github_username_placeholder' => 'Enter GitHub username',
    'enter_personal_access_token_placeholder' => 'Enter Personal Access Token',
    'enter_msg91_auth_key_placeholder' => 'Enter your MSG91 Auth Key',
    'enter_sender_id_placeholder' => 'Enter Sender ID',
    'enter_template_id_placeholder' => 'Enter Template ID',
    'deployment' => 'Deployment',
    'queue_monitor' => 'Queue Monitor',
    'footer_1' => 'Footer 1',
    'footer_2' => 'Footer 2',
    'footer_3' => 'Footer 3',
    'custom_enter_own_icon' => 'Custom (Enter your own icon)',
