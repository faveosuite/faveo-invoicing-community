...
class PhoneNumberControllerTest extends DBTestCase
{
    ...
    public function test_validate_returns_valid_result_for_valid_us_phone_number()
    {
    ...
    public function test_validate_returns_valid_result_for_valid_indian_phone_number()
    {
    ...
    public function test_validate_returns_valid_result_without_country_code_when_number_has_plus()
    {
    ...
    public function test_validate_returns_valid_result_for_uk_phone_number()
    {
    ...
    public function test_validate_returns_formatted_numbers_in_all_formats()
    {
        $result = $this->controller->validate('+14155551234', 'US');
    ...
    public function test_validate_returns_phone_number_type()
    {
        $result = $this->controller->validate('+919876543210', 'IN');
    ...
    public function test_validate_returns_invalid_for_too_short_phone_number()
    {
    ...
    public function test_validate_returns_invalid_for_too_long_phone_number()
    {
    ...
    public function test_validate_returns_invalid_for_non_numeric_phone_number()
    {
    ...
    public function test_validate_returns_error_for_invalid_country_code()
    {
    ...
    public function test_validate_returns_national_number_correctly()
    {
        $result = $this->controller->validate('+14155551234', 'US');
    ...
    public function test_validate_handles_phone_number_with_spaces()
    {
    ...
    public function test_validate_handles_phone_number_with_dashes()
    {
        $result = $this->controller->validate('+1-415-555-1234', 'US');
    ...
    public function test_validate_handles_phone_number_with_parentheses()
    {
    ...
    public function test_is_valid_returns_true_for_valid_phone_number()
    {
    ...
    public function test_is_valid_returns_false_for_invalid_phone_number()
    {
    ...
    public function test_is_valid_strict_mode_returns_true_for_valid_number()
    {
        $result = $this->controller->isValid('+14155551234', 'US', true);

        $this->assertTrue($result);
    }

    public function test_is_valid_strict_mode_returns_false_for_invalid_number()
    {
        $result = $this->controller->isValid('123', 'US', true);

        $this->assertFalse($result);
    }

    public function test_is_valid_without_country_code_for_international_number()
    {
    ...
    public function test_is_valid_returns_false_for_empty_string()
    {
    ...
    public function test_is_mobile_returns_true_for_mobile_number()
    {
    ...
    public function test_is_mobile_returns_false_for_invalid_number()
    {
    ...
    public function test_is_mobile_returns_false_for_fixed_line_number()
    {
    ...
    public function test_is_mobile_returns_true_for_fixed_line_or_mobile_type()
    {
    ...
    public function test_format_e164_returns_correct_format()
    {
    ...
    public function test_format_e164_returns_null_for_invalid_number()
    {
    ...
    public function test_format_e164_with_national_number_and_country_code()
    {
    ...
    public function test_format_e164_removes_spaces_and_special_characters()
    {
    ...
    public function test_format_international_returns_correct_format()
    {
    ...
    public function test_format_international_returns_null_for_invalid_number()
    {
    ...
    public function test_format_international_for_indian_number()
    {
    ...
    public function test_format_national_returns_correct_format()
    {
    ...
    public function test_format_national_returns_null_for_invalid_number()
    {
    ...
    public function test_format_national_for_indian_number()
    {
    ...
    public function test_parse_returns_array_with_correct_keys()
    {
    ...
    public function test_parse_returns_correct_values()
    {
    ...
    public function test_parse_returns_null_for_invalid_number()
    {
    ...
    public function test_parse_works_without_country_code_for_international_format()
    {
        // Using a verified valid GB mobile number
    ...
    public function test_validate_with_mobile_code_returns_valid_result()
    {
    ...
    public function test_validate_with_mobile_code_handles_plus_prefix()
    {
        $result = $this->controller->validateWithMobileCode('+91', '9876543210', 'IN');
    ...
    public function test_validate_with_mobile_code_strips_leading_zeros()
    {
    ...
    public function test_validate_with_mobile_code_for_us_number()
    {
    ...
    public function test_validate_with_mobile_code_returns_invalid_for_wrong_mobile_code()
    {
    ...
    public function test_validate_with_mobile_code_without_country_iso()
    {
    ...
    public function test_normalize_for_storage_returns_correct_structure()
    {
    ...
    public function test_normalize_for_storage_returns_correct_values()
    {
        $result = $this->controller->normalizeForStorage('91', '9876543210', 'IN');
    ...
    public function test_normalize_for_storage_returns_null_for_invalid_number()
    {
    ...
    public function test_normalize_for_storage_for_us_number()
    {
    ...
    public function test_normalize_for_storage_strips_leading_zeros()
    {
    ...
    public function test_normalize_for_storage_handles_plus_prefix_in_mobile_code()
    {
        $result = $this->controller->normalizeForStorage('+91', '9876543210', 'IN');
    ...
    public function test_get_example_number_returns_mobile_example()
    {
        $result = $this->controller->getExampleNumber('US', true);

        $this->assertNotNull($result);
        $this->assertIsString($result);
    }

    public function test_get_example_number_returns_fixed_line_example()
    {
        $result = $this->controller->getExampleNumber('US', false);

        $this->assertNotNull($result);
        $this->assertIsString($result);
    }

    public function test_get_example_number_for_india()
    {
        $result = $this->controller->getExampleNumber('IN', true);

        $this->assertNotNull($result);
        $this->assertStringContainsString('+91', $result);
    }

    public function test_get_example_number_for_uk()
    {
        $result = $this->controller->getExampleNumber('GB', true);
    ...
    public function test_get_example_number_returns_valid_examples_for_different_countries()
    {
    ...
    public function test_get_example_number_default_is_mobile()
    {
        $mobileExample = $this->controller->getExampleNumber('US');
        $mobileExampleExplicit = $this->controller->getExampleNumber('US', true);
    ...
    public function test_get_country_calling_code_returns_correct_code_for_us()
    {
    ...
    public function test_get_country_calling_code_returns_correct_code_for_india()
    {
    ...
    public function test_get_country_calling_code_returns_correct_code_for_uk()
    {
    ...
    public function test_get_country_calling_code_returns_correct_code_for_germany()
    {
    ...
    public function test_get_country_calling_code_returns_correct_code_for_australia()
    {
    ...
    public function test_get_country_calling_code_returns_correct_code_for_japan()
    {
    ...
    public function test_get_country_calling_code_returns_null_for_invalid_country()
    {
    ...
    public function test_get_number_type_name_returns_mobile()
    {
    ...
    public function test_get_number_type_name_returns_fixed_line()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getNumberTypeName',
    ...
    public function test_get_number_type_name_returns_toll_free()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getNumberTypeName',
    ...
    public function test_get_number_type_name_returns_voip()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getNumberTypeName',
    ...
    public function test_get_error_message_for_invalid_country_code()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getErrorMessage',
    ...
    public function test_get_error_message_for_not_a_number()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getErrorMessage',
    ...
    public function test_get_error_message_for_too_short_nsn()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getErrorMessage',
    ...
    public function test_get_error_message_for_too_long()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getErrorMessage',
    ...
    public function test_get_error_message_for_too_short_after_idd()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getErrorMessage',
    ...
    public function test_get_error_message_for_unknown_error_type()
    {
        $result = $this->getPrivateMethod(
            $this->controller,
            'getErrorMessage',
    ...
    public function test_validate_handles_empty_string()
    {
    ...
    public function test_validate_handles_special_characters_only()
    {
        $result = $this->controller->validate('++--##', 'US');
    ...
    public function test_validate_handles_very_long_valid_format()
    {
    ...
    public function test_multiple_countries_with_same_calling_code()
    {
    ...
    public function test_validate_canadian_number()
    {
    ...
    public function test_validate_australian_number()
    {
    ...
    public function test_validate_german_number()
    {
    ...
    public function test_validate_japanese_number()
    {
    ...
    public function test_validate_french_number()
    {
    ...
    public function test_validate_brazilian_number()
    {
    ...
    public function test_validate_chinese_number()
    {
    ...
    public function test_constructor_initializes_phone_util()
    {
    ...
    public function test_format_methods_return_null_for_empty_string()
    {
    ...
    public function test_is_mobile_with_international_format()
    {
    ...
    public function test_normalize_for_storage_returns_string_types()
    {
        $result = $this->controller->normalizeForStorage('91', '9876543210', 'IN');
    ...
    public function test_get_example_number_returns_formatted_string()
    {
        $result = $this->controller->getExampleNumber('IN', true);
    ...
    public function test_validate_toll_free_number()
    {
    ...
    public function test_validate_premium_rate_number()
    {
    ...
    public function test_validate_premium_or_shared_cost_number()
    {
