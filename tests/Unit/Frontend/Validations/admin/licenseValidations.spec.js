...
describe('bannedHostSchema', () => {
    it('passes with a valid IP', async () => {
        await expect(bannedHostSchema.validate({ banned_host_ip: '192.168.1.1' })).resolves.toBeTruthy()
    })
...
describe('whitelistSchema', () => {
    it('passes with a valid IP', async () => {
        await expect(whitelistSchema.validate({ whitelist_host_ip: '10.0.0.1' })).resolves.toBeTruthy()
    })
...
describe('installationSchema', () => {
    it('passes with a valid IP', async () => {
        await expect(installationSchema.validate({ installation_ip: '203.0.113.5' })).resolves.toBeTruthy()
    })
