...
jest.mock('@/validations/admin/githubValidations', () => ({ githubSchema: {} }))

import { mount } from '@vue/test-utils'
import { createTestingPinia } from '@pinia/testing'
import GithubSettings from '@/pages/admin/settings/api/GithubSettings.vue'
...
describe('GithubSettings.vue', () => {
    ...
    it('populates form from API response', async () => {
        await flushPromises()
        expect(wrapper.vm.form.git_username).toBe('octocat')
        expect(wrapper.vm.form.git_password).toBe('secret')
    })

    it('sends POST /github-setting on save()', async () => {
        await flushPromises()
