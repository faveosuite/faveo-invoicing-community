              ...
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                  <!-- description -->
                    ...
                    {!! html()->text('price_description')->class('form-control'.($errors->has('price_description') ? ' is-invalid' : ''))->placeholder('Enter Price Description to be Shown on Pricing Page. eg: Yearly,Monthly,One-Time') !!}
                  <h6 id="dayscheck"></h6>
                ...
                <div class="col-md-6 form-group">
                  <!-- product_quantity -->
                    ...
                    {!! html()->number('product_quantity')->class('form-control'.($errors->has('product_quantity') ? ' is-invalid' : ''))->id('prodquant')->disabled()->placeholder('Pricing for No. of Products') !!}
                ...
                <div class="col-md-6 form-group">
                  ...
                  <i class='fa fa-info-circle' style='cursor: help; font-size: small; color: rgb(60, 141, 188)'<label data-toggle="tooltip" style="font-weight:500;" data-placement="top" title="If '0' Agents Selected, Plan will be for Unlimited Agents.">
                    ...
                    {!! html()->number('no_of_agents')->class('form-control'.($errors->has('no_of_agents') ? ' is-invalid' : ''))->id('agentquant')->disabled()->placeholder('Pricing for No. of Agents') !!}
                    @error('no_of_agents')
                    <span class="error-message"> {{$message}}</span>
                    @enderror
                    <div class="input-group-append">
