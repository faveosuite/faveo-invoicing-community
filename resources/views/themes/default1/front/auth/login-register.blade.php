    ...
    ->style('height: calc(1.5em + 0.75rem + 2px);') !!}
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col">
                                ...
                                <button type="submit" id="login-btn"  class="btn btn-dark btn-modern w-100 text-uppercase font-weight-bold text-3 py-3" data-loading-text="Loading...">Login</button>
