        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group {{ $errors->has('plan') ? 'has-error' : '' }}">
                        ...
                        {!! Form::select('plan',[''=> __('message.select'),'Plans'=>$plans],null,['class' => 'form-control','onchange'=>'getPrice(this.value)']) !!}
                   ...
                   <div class="form-group {{ $errors->has('payment_method') ? 'has-error' : '' }}">
                        ...
                        {!! Form::select('payment_method',[''=> __('message.search'),'cash'=>'Cash','check'=>'Check','online payment'=>'Online Payment','razorpay'=>'Razorpay'],null,['class' => 'form-control']) !!}
