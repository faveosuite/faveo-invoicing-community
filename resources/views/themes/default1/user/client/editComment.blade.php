        ...
        <div class="modal-content">
           ...
           {!! Form::open(['method' => 'patch', 'id' =>  'comment-edit-form'])!!}
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-primary " id="edit_submit" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'>&nbsp;</i> Saving..."><i class="fas fa-refresh">&nbsp;&nbsp;</i>{!!Lang::get('message.update')!!}</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
