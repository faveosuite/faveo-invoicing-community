export default [
    { path: '/settings/common/tax',            component: () => import('../../../pages/settings/common/tax/TaxIndex.vue'),  meta: { title: 'Tax',        titleKey: 'message.tax' } },
    { path: '/settings/common/tax/create',    component: () => import('../../../pages/settings/common/tax/TaxCreate.vue'), meta: { title: 'Create Tax', titleKey: 'message.tax' } },
    { path: '/settings/common/tax/:id/edit',  component: () => import('../../../pages/settings/common/tax/TaxEdit.vue'),   meta: { title: 'Edit Tax',   titleKey: 'message.edit_tax' } },
