export default [
    ...
    { path: '/settings/widgets/social-media/create',   component: () => import('../../../pages/settings/widgets/socialMedia/Create.vue'),   meta: { title: 'Add Social Media', titleKey: 'message.add_social_media' } },
