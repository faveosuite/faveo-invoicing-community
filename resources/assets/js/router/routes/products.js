export default [
    ...
    { path: '/products/create',             component: () => import('../../pages/products/Create.vue'),              meta: { title: 'New Product',  titleKey: 'message.new_product' } },
    ...
    { path: '/products/coupons/create',     component: () => import('../../pages/products/coupons/Create.vue'),     meta: { title: 'New Coupon',   titleKey: 'message.new_coupon' } },
    ...
    { path: '/products/groups/create',      component: () => import('../../pages/products/groups/Create.vue'),      meta: { title: 'New Group',    titleKey: 'message.new_group' } },
