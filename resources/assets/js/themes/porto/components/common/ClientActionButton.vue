...
const ACTION_MAP = {
    ...
    cancel:   { variant: 'light',     icon: 'fas fa-times',       label: 'cancel' },
    close:    { variant: 'light',     icon: 'fas fa-times',       label: 'close' },
    back:     { variant: 'light',     icon: 'fas fa-arrow-left',  label: 'back' },
    download: { variant: 'light',     icon: 'fas fa-download',    label: 'download' },
    upload:   { variant: 'light',     icon: 'fas fa-upload',      label: 'upload' },
    reset:    { variant: 'light',     icon: 'fas fa-undo',        label: 'reset' },
    export:   { variant: 'light',     icon: 'fas fa-file-export', label: 'export' },
    import:   { variant: 'light',     icon: 'fas fa-file-import', label: 'import' },
    refresh:  { variant: 'light',     icon: 'fas fa-sync-alt',    label: 'refresh' },
    filter:   { variant: 'light',     icon: 'fas fa-filter',      label: 'filter' },
    sync:     { variant: 'light',     icon: 'fas fa-sync-alt',    label: 'sync' },
...
const resolvedVariant = computed(() => props.variant || meta.value.variant || 'light')
