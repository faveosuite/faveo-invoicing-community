export default [
    ...
    { path: '/settings/payment-gateway',          component: () => import('../../../pages/admin/settings/settings/paymentGateway/PaymentGatewayIndex.vue'), meta: { title: 'Payment Gateway Integrations', titleKey: 'message.payment_gateway_integrations' } },
