export default [
    ...
    { path: '/settings/common/countries',    component: () => import('../../../pages/admin/settings/common/CountryList.vue'), meta: { title: 'All Countries', titleKey: 'message.all_countries' } },
    { path: '/settings/common/queues',          component: () => import('../../../pages/admin/settings/common/Queues.vue'),              meta: { title: 'All Queues',               titleKey: 'message.all_queues' } },
