...
# Exact spelling: this one goes into a GitHub SEARCH query (label:"…"), which is
# matched server-side and is NOT covered by the tolerant resolution in
# gh-client.sh. Verified against the repo's label list.
EXECUTE_LABEL="${QA_PR_TRIGGER_LABEL:-Requires Functionality Review}"
