...
<div class="wrapper">
                        ...
                        <div class="wrapper option-1 option-1-1">
                            <ol class="c-stepper p-3">
                                <li class="c-stepper__item active" id="server">
                                    ...
                                    <p class="c-stepper__title fs-6"><?= $lang['server_requirements'] ?></p>
                                </li>
                                <li class="c-stepper__item" id="database">
                                    <div class="c-stepper__icon">2</div>
                                    <p class="c-stepper__title fs-6"><?= $lang['database_setup'] ?></p>
                                </li>
                                <li class="c-stepper__item" id="start">
                                    <div class="c-stepper__icon">3</div>
                                    <p class="c-stepper__title fs-6"><?= $lang['getting_started'] ?></p>
                                </li>
                                <li class="c-stepper__item" id="final">
                                    <div class="c-stepper__icon">4</div>
                                    <p class="c-stepper__title fs-6"><?= $lang['final'] ?></p>
                                </li>
                            </ol>
                        </div>
    ...
    <footer class="main-footer">
        ...
        <strong><?= $lang['copyright'] ?> © 2015 - <?= date('Y') ?> <span class="cursor-normal text-primary">Ladybird Web Solution Pvt Ltd.</span></strong> <?= $lang['powered_by'] ?> <strong><a href="https://www.faveohelpdesk.com/" target="_blank">Faveo</a></strong>
    </footer>
</div>
